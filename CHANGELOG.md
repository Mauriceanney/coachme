...
### Changed
- Rename npm package from create-agentic-app to create-agentic-saas (package name conflict)
- Rename create-agentic-app directory to create-agentic-saas
...
- Add create-agentic-app sync to checkpoint and release (commands)
...
- Rename create-agentic-coding-starter to create-agentic-app
